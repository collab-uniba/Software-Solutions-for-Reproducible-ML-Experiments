...
X_train_path = prepared_folder_path / 'X_train.pkl'
y_train_path = prepared_folder_path / 'y_train.pkl'
X_valid_path = prepared_folder_path / 'X_valid.pkl'
y_valid_path = prepared_folder_path / 'y_valid.pkl'
...
X_valid.to_pickle(X_valid_path)
print("Writing file {} to disk.".format(X_valid_path))

y_valid.to_pickle(y_valid_path)
